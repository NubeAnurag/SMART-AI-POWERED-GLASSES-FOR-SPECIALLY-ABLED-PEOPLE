#!/usr/bin/env python3
"""
Runner script for Smart Voice-Enabled Human Detection and Identification System
"""
...
def main():
    ...
    print("🧠 Smart Voice-Enabled Human Detection and Identification System")
    print("=" * 80)
    
    # Check audio permissions
    check_audio_permissions()
    
    print("🎯 Starting the smart voice-enabled system...")
    print("📋 Instructions:")
    ...
    print()
    print("🗣️  System will extract and speak:")
    print("   • Name, age, relationship")
    print("   • How you know each other")
    print("   • Interests and additional info")
    print("   • Natural spoken summary")
    print()
    
    # Try to run the system
    try:
        from smart_voice_system import main as run_system
        run_system()
